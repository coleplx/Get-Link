...
var re = /https?:\/\/docs\.google\.com\/file\/d\/([a-zA-Z0-9-]+)(\/.+)?/
var result = {}
...
var getFileInfo = function(callback) {
	...
	request(options, function (error, response, body) {
        ...
        if (response.statusCode !== 200)
            return callback(new Error('Tài liệu không hợp lệ hoặc đã bị xóa'))
...
var download = function(callback) {
    var url = 'https://docs.google.com/uc?export=download&id=' + result.uid

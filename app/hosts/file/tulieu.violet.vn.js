...
var re = /http:\/\/tulieu.violet.vn\/document\/show\/entry_id\/(\d+)/
var result = {}
...
var login = function(username, password, callback) {
	var options = {
		uri: 'http://tulieu.violet.vn/user/login',
		method: 'POST',
		form: {
    		"_": "",
    		"username": username,
...
var download = function(callback) {
	var options = {
		uri: 'http://tulieu.violet.vn/document/download/doc_id/' + result.download_id,
		method: 'HEAD',
		headers: {
    		"User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/52.0.2743.60 Safari/537.36"
		},
